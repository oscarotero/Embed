...
return [
    'headers' => [
        ...
        'set-cookie' => [
            'localization=es-us%3Bes%3Bes; expires=Wed, 21-Sep-2022 21:47:03 GMT; Max-Age=62899200; path=/; domain=.flickr.com'
        ],
        ...
        'via' => [
            '1.1 3955eedbb92ae55c47973123806d420c.cloudfront.net (CloudFront)'
        ],
        'x-amz-cf-pop' => [
            'MAD51-C1'
        ],
        'x-amz-cf-id' => [
            '1w_gbJbqJIefmUfE2o-Hie9DiBjfaRHnepIVkcWCLM5uPEYBX0yE8g=='
        ],
        'Content-Location' => [
